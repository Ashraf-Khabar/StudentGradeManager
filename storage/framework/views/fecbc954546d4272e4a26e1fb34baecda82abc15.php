    ...
    <div class="text-center" style="margin-top: 33px;">
        <?php if(Route::has('login')): ?>
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(url('/dashboard')); ?>" class="btn btn-primary" type="button"
                   style="border-radius: 27px;background:midnightblue;font-weight: bold;margin-top: 97px;">Dashboard
                </a>
            <?php else: ?>
                <a href="<?php echo e(route('login')); ?>" class="bt btn btn-primary" type="button"
...
<?php /**PATH C:\Users\yolo\Documents\GitHub\Platform-of-management-of-students\resources\views/welcome.blade.php ENDPATH**/ ?>