        ...
        <table class="table table-hover table-bordered">
            ...
            <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr style="color: #decdcd ; background-color: #2c2929">
                    ...
                    <td>
                        <form action="<?php echo e(asset('Eleves/'.$item->id)); ?>" method="POST">
                            <a href="<?php echo e(asset('Eleves/'.$item->id.'/edit')); ?>" class="btn btn-success" style="margin-left: 5px;" type="submit"><i
...
<?php /**PATH C:\Users\yolo\Documents\GitHub\Platform-of-management-of-students\resources\views/admin/eleve_manip/eleve_index.blade.php ENDPATH**/ ?>