                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <?php if(Route::has('register')): ?>
                            <a style="color: #dc3855" href="<?php echo e(route('register')); ?>" class="nav-link active" >Register</a>
                        <?php endif; ?>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <li><a class="dropdown-item" href="<?php echo e(url('Eleves')); ?>">Modify student</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(url('Responsable_filieres')); ?>">modify Responsable_filiere</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(url('Filieres')); ?>">modify filiere</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
            ...
            <div class="col-12 text-center col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                <div class="text-center icon-box">
                    <div class="icon"><i class="fas fa-chalkboard-teacher" style="margin-bottom: 15px;"></i><h4
                            class="title"><a href="<?php echo e(url('Eleves')); ?>">Etudiants</a></h4>
            ...
            <div class="col-12 text-center col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                <div class="text-center icon-box">
                    <div class="icon"><i class="fas fa-book-open" style="margin-bottom: 15px;"></i><h4 class="title">
                            <a href="<?php echo e(url('Filieres')); ?>">Filieres</a></h4>
            ...
            <div class="col-12 text-center col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                <div class="text-center icon-box">
                    <div class="icon"><i class="far fa-registered" style="margin-bottom: 15px;"></i><h4 class="title">
                            <a href="<?php echo e(route('register')); ?>">Register</a></h4>
...
<?php /**PATH C:\Users\yolo\Documents\GitHub\Platform-of-management-of-students\resources\views/admin_dashboard.blade.php ENDPATH**/ ?>