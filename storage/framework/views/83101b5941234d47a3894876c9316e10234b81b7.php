...
<div class="col-md-12 search-table-col"><span class="counter pull-right"></span>
    <div style="text-align: center;">
        <div class="main">
            <h1 style="color: red">Branches Informations</h1><br><br>
            <a style="text-decoration: none" class="button-24" role="button" href="<?php echo e(url('admin_dashboard')); ?>">back</a>
            <a style="text-decoration: none" class="button-24" role="button" href="<?php echo e(url('Filieres/create')); ?>">create</a>
            <br><br>
        ...
        <table class="table table-hover table-bordered">
            ...
            <?php $__currentLoopData = $filieres; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr style="color: #decdcd ; background-color: #2c2929">
                    ...
                    <td><form action="<?php echo e(url('Filieres/'.$item->id)); ?>" method="POST">
                            <a href="<?php echo e(url('Filieres/'.$item->id.'/edit')); ?>" class="btn btn-success" style="margin-left: 5px;" type="submit"><i
...
<?php /**PATH C:\Users\yolo\Documents\GitHub\Platform-of-management-of-students\resources\views/admin/filiere_manip/filiere_index.blade.php ENDPATH**/ ?>