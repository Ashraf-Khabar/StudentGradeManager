...
<div class="col-md-12 search-table-col"><span class="counter pull-right"></span>
    <div style="text-align: center;">
        <div class="main">
            ...
            <a style="text-decoration: none" class="button-24" role="button" href="{{url('Filieres/create')}}">create</a>
            <br><br>
            ...
            @foreach ($filieres as $item)
                <tr style="color: #decdcd ; background-color: #2c2929">
                    ...
                    <td><form action="{{url('Filieres/'.$item->id)}}" method="POST">
                            <a href="{{url('Filieres/'.$item->id.'/edit')}}" class="btn btn-success" style="margin-left: 5px;" type="submit"><i
